<div class="sidebar" data-color="azure">
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            ...
            <li class="nav-item @if($activePage == 'upload') active @endif">
                <a class="nav-link" href="{{route('page.index','upload')}}">
                    <i class="fa fa-cloud-upload-alt"></i>
                    <p>{{ __("Upload") }}</p>
                </a>
            </li>
            <li class="nav-item @if($activePage == 'tables') active @endif">
                <a class="nav-link" href="{{route('page.index', 'tables')}}">
